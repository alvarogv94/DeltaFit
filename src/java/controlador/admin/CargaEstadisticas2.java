 ...
 * @author Alvaro
 */
public class CargaEstadisticas2 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (usuario == 0) {
            ...
            List<Atleta> listaAtletas = atletaControl.findAtletaEntities();
            for (int i = 0; i < listaAtletas.size(); i++) {
                Integer tipoUsuario = listaAtletas.get(i).getTipoUsuario();
                if (tipoUsuario == 1) {
                    opcion1++;
                }
